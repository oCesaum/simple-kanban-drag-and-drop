  ...
  return (
    <div className="App min-h-screen bg-[#130F0D]">
      <header className="flex justify-between items-center text-white py-5 px-10 font-bold uppercase">
        ...
        >
          <h1
            className="text-2xl hover:text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-pink-600"
        ...
        <div className="flex gap-3">
          ...
          >
            <svg
              className="w-7 h-7 fill-white hover:fill-[url(#gradiente)]"
      ...
      <main className="text-white py-8 px-10">
